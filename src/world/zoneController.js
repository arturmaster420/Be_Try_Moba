...
export const ZONE_RADII = {
  // Map size reduced 4x vs original (another 2x smaller)
  0: 500,   // Hub radius
  1: 2500,
  2: 5000,
  3: 7500,
  4: 10000,
  5: 12500, // Zone 6 starts here
  6: 15000, // Outer square half-size (world bounds)
};
...
export function getZone(x, y) {
  if (typeof y === "undefined") {
    ...
    if (yy < 5000) return 2;
    if (yy < 7500) return 3;
    if (yy < 10000) return 4;
    if (yy < 12500) return 5;
    return 6;
  }
