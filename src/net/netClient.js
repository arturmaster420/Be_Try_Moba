...
export function createNetClient() {
  ...
  net.host = function host(roomCode, nickname, avatarIndex) {
    send({ type: "host", roomCode, nickname, avatarIndex });
  };

  net.join = function join(roomCode, nickname, avatarIndex) {
    send({ type: "join", roomCode, nickname, avatarIndex });
  };

  net.fastJoin = function fastJoin(nickname, avatarIndex) {
    send({ type: "fastJoin", nickname, avatarIndex });
  };
  ...
  net.setProfile = function setProfile(nickname, avatarIndex) {
    send({ type: "setProfile", nickname, avatarIndex });
  };
