...
function roomInfo(room) {
  ...
  for (const [id, c] of room.clients) {
    players.push({ id, nickname: c.nickname || "Player", avatarIndex: (c.avatarIndex||0), ready: !!c.ready, isHost: id === room.hostId });
  }
  return {
    type: "roomInfo",
    roomCode: room.code,
...
wss.on("connection", (ws) => {
  ...
  ws.on("message", (data) => {
    ...
    if (msg.type === "host") {
      ...
      room.clients.set(clientId, { ws, nickname: client.nickname, avatarIndex: client.avatarIndex||0, ready: !!client.ready, lastSeen: client.lastSeen });
    ...
    if (msg.type === "fastJoin") {
      ...
      newRoom.clients.set(clientId, { ws, nickname: client.nickname, avatarIndex: client.avatarIndex||0, ready: !!client.ready, lastSeen: client.lastSeen });
